...
--
-- Host: 10.0.10.154    Database: radius
-- ------------------------------------------------------
...
--
-- Table structure for table `isp_subscribers`
--

DROP TABLE IF EXISTS `isp_subscribers`;
...
CREATE TABLE `radpostauth` (
  ...
  KEY `username` (`username`),
  KEY `class` (`class`)
) ENGINE=InnoDB AUTO_INCREMENT=10711 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2026-09-07 22:01:54
